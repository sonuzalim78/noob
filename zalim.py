...
for xd in range(10000):
    ...
    g='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'      'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36',}
